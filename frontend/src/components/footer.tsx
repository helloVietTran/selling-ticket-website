        ...
        <footer className="bg-[#1f1f2e] text-gray-300 px-5 py-10">
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-6 text-center md:text-left">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-base font-bold text-[#00c853]">1900.6408</p>

                    <h3 className="text-white font-bold mt-6 mb-2">Email</h3>
                    <div className="flex items-center justify-center md:justify-start gap-2 text-sm text-gray-400">
                        <Mail size={16} />
                        <span>spnhom1@ticketbox.vn</span>
                    </div>

                    <h3 className="text-white font-bold mt-6 mb-2">Văn phòng chính</h3>
                ...
                <div className="space-y-4">
                    ...
                    <h3 className="text-white font-bold mt-6 mb-2">Dành cho Ban Tổ chức</h3>
                    <ul className="space-y-2 text-sm text-gray-400">
                        <li>
                            <Link
                                to="#"
