...
export default function EventDrawer({ isOpen, onClose, eventId }: EventDrawerProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto space-y-3">
              ...
              <Link
                ...
                className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-emerald-700/70 transition-colors"
              >
                <DollarSign size={18} />
                <span>Doanh thu</span>
              </Link>
