            ...
            <Table>
                <TableHeader>
                    <TableRow className="bg-[#31353e] hover:bg-[#31353e]">
                        ...
                        <TableHead className="text-white px-4 py-2">Tỉ lệ check-in</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {fakeData.map((ticket, index) => {
                        const percent =
                            ticket.sold > 0 ? Math.round((ticket.checkedIn / ticket.sold) * 100) : 0;
                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCell className="px-4 py-2">{ticket.price.toLocaleString()}đ</TableCell>
