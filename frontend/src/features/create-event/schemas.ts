...
export const tickeTypeSchema = z
  .object({
    ...
    endSellDate: z.string().min(1, 'Chọn thời gian kết thúc kết thúc bán vé'),
  })
...
export const timeAndTicketTypeSchema = z
  .object({
    startTime: z.string().nonempty('Chọn ngày bắt đầu'),
    endTime: z.string().nonempty('Chọn ngày kết thúc'),
